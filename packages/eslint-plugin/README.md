...
```shell
$ npm install eslint-plugin-eva eslint --save-dev
```
...
// .eslintrc.js
module.exports = {
  plugin: ['eslint-config-eva'],
  rules: {
    'eslint-plugin-eva/no-secret-info': 'error',
  },
};
```
...
// .eslintrc.js
module.exports = {
  extends: 'plugin:eslint-plugin-eva/recommended',
};
```
